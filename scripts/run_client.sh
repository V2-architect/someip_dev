...
CONF_FILE_TMP=${APP_ROOT}/client-${HOSTNAME}.json.tmp
...
LOGGING_FILEPATH="/root/someip_app/logs/${HOSTNAME}-${SERVICE_NAME}-client.log"
...
VSOMEIP_CONFIGURATION=$CONF_FILE \
    ...
    ${APP_ROOT}/${SERVICE_NAME}_client_$TRANSPORT_PROTOCOL ${HOSTNAME}
